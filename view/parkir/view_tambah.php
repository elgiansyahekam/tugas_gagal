...
<nav class="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
    ...
    <div class="container">
        ...
        <form action="proses_tambah.php" method="POST">
            <div class="mb-3">
                <label for="plat_nomor" class="form-label">no parkir</label>
            ...
            <div class="mb-3">
                <label for="jenis_kendaraan" class="form-label">tarif kendaraan</label>
                <input type="text" class="form-control" name="tarif_parkir" id="tarif_parkir" required>
            </div>
